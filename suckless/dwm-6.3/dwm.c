...
togglebar(const Arg *arg)
{
	...
	//selmon->showbar = !selmon->showbar; //bar globally as of before pertag patch
    selmon->showbar = selmon->pertag->showbars[selmon->pertag->curtag] = !selmon->showbar; //bar per tag is of pertag patch
	updatebarpos(selmon);
